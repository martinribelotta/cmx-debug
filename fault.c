...
static void bf_call_handler_main(context_t *ctx)
{
...
void BusFault_Handler(void)
{
   __asm__ volatile (
      ...
      "  mov sp, r0\n"
      "  push {r4-r11}\n"
      "  b %[bf_call_handler_main]\t\n"
      : /* no output */
      : [bf_call_handler_main] "i" (bf_call_handler_main) /* input */
      : "r0" /* clobber */
   );
}
...
static void sv_call_handler_main(context_t *ctx)
{
